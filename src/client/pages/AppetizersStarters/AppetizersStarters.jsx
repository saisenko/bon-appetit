...
import styles from './AppetizersStarters.module.css';
...
function AppetizersStarters() {
    ...
    useEffect(() => {
        axios.get(`${apiEndpoint}/api/menu/appetizers-n-starters`)
        .then(response => {
  ...
  return (
    <div>
      <Header pageTitle={"🥗 Appetizers & Starters 🥗"}/>
...
export default AppetizersStarters;